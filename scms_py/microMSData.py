...
class microMSData():
	...
	def select_micromsIntens(self, channel1, channel2, thres1=widgets.IntRangeSlider(value=(250, 750), min=0, max=1000, step=1), thres2=widgets.IntRangeSlider(value=(250, 750), min=0, max=1000, step=1)):
    
		x = np.array(self.obs['integrated_intens_'+channel1])
		y = np.array(self.obs['integrated_intens_'+channel2])
        
		thres1 = tuple(i/1000 for i in thres1)
		thres2 = tuple(i/1000 for i in thres2)
